...
# THE STAGE-1 CURRENT STATE BLOCK, MOVED HERE AT CLOSURE — 2026-09-21

**What this is.** PROGRESS.md's CURRENT STATE block **as of commit `986e42f`, lines
3–670**, moved here **verbatim** when owner pins 260–267 (ruling PART 60) closed Gate 1 and
Stage 1. **Moved, not rewritten and not deleted** — the same instrument as the 2026-09-18
move above. The byte content below is exactly what PROGRESS.md carried, blockquote
preserved, all **18** `> ##` sections of it.

**Why moved.** Pin 154 makes the CURRENT STATE block the only block describing now, and
closure falsified most of its sentences at once (finding F3: the staleness was block-wide,
not one line). Rewriting in place would have layered a closed stage over an open one. Two
of its sections were **carried forward verbatim** into the new block because they are still
in force — *Standing practice — ruled, not preference* and *THE OWNER MAY WORK THIS REPO
